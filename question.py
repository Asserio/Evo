...
async def __search_method1(texts, answers, reverse):
    ...
    print(f"{Fore.RED}{counts}{Style.RESET_ALL}")
...
async def __search_method3(question_keywords, question_key_nouns, answers, reverse):
    ...
    print(f"Keyword scores:{Fore.RED} {keyword_scores}{Style.RESET_ALL}")
    print(f"Noun scores:{Fore.GREEN} {noun_scores}{Style.RESET_ALL}")
